    ...
    <>
      ...
      <div className="max-w-screen-2xl container mx-auto px-4 py-12">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-center mb-6 text-black">Our Mission</h2>
        ...
        {/* Our Team Section */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-center mb-8 text-black">Our Team</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-black">Head of Content</p>
              <p className="text-black mt-2">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <img
                ...
                className="w-32 h-32 rounded-full mx-auto mb-4"
              />
              <h3 className="text-xl font-semibold text-black">Mike Johnson</h3>
        ...
        <section className="text-center">
          ...
          <button className="bg-blue-500 text-black px-6 py-3 rounded-lg hover:bg-blue-600 transition duration-300">
            Get Started
          </button>
        </section>
      </div>
