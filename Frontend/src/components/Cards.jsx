    ...
    <div className="card-body p-3 flex flex-col justify-between">
      ...
      <div className="card-actions flex justify-between items-center mt-3">
        ...
        <div className="flex gap-2">
          ...
          <button className="px-3 py-1.5 bg-green-600 text-white rounded-full text-xs hover:bg-green-700 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 dark:bg-green-700 dark:hover:bg-green-600">
            Buy Now
          </button>
        </div>
      </div>
