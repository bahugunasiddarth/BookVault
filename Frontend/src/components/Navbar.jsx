  ...
  return (
    <div
      className={`max-w-screen-2xl container mx-auto md:px-20 px-4 bg-white text-black fixed top-0 left-0 right-0 z-50 ${
        sticky ? "sticky-navbar shadow-md bg-white text-black duration-300 transition-all ease-in-out" : ""
      }`}
    >
      <div className="navbar">
        <div className="navbar-start">
          ...
          <a href="/" className="text-2xl font-bold cursor-pointer">BookVault</a>
        </div>
